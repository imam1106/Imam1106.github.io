...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const products = [
        {
            title: "Ayam Geprek",
            description: "Ayam geprek kami bukan sekedar menu, melainkan sebuah cerita panjang tentang dedikasi kami untuk memberikan yang terbaik. Dengan ayam pilihan dan sambal berbumbu, kami mengajak Anda untuk merasakan petualangan rasa yang memikat, memenuhi hasrat kuliner Anda dalam setiap sajian.",
